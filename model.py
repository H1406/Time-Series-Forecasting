...
# Usage: 
# ModelConfig = ModelConfig(context_len=50, target_len=20)
# model = SimpleLSTMTransformerSeq2Seq(ModelConfig)
# model = LSTMTransformerDiffusion(ModelConfig)  # For diffusion-based model